...
<form  name ="cmd" method="POST"action="index.php?controller=Commande&action=CommandePassee" onsubmit="return validationnombre(document.cmd.Product_Quantity)"> 
<fieldset> 
<legend>Ajout d'une commande </legend> 
<p> <label for="Commande_ID">Commande ID</label> : 
<input type="text" name="Commande_ID" id="Commande_ID"  required /> </p> 
...
<input type="tel" name="Tel" id="Tel" required /> </p> 
		...
		<input type="radio" name="Paiment_Mode" value="cash" id="montant total" required  /> 
        <label for=" montant total"> Cash </label><br />
		<input type="radio" name="Paiment_Mode" value="2 parties" id=" 2 parties"  required /> 
        <label for=" 2 parties">Paiement sur 2 parties</label><br />
        <input type="radio" name="Paiment_Mode" value="3 parties" id="3 parties"  required />
        <label for="3 parties">Paiement sur 3 parties</label><br />
		<input type="radio" name="Paiment_Mode" value="4 parties" id="4 parties" required  />
