<form  name="prd" method="POST" action="index.php?controller=Productstock&action=ProduitEnregistre" onsubmit="return validationnombre(document.prd.Product_Quantity)"> 
<fieldset> 
